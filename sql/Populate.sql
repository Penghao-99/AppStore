...
insert into listings (car_vin, carmake, model, year, mileage, rate, owner) values ('WAUSFAFL2BA782648', 'Volkswagen', 'C'ksprulls4@fda.gov'abriolet', 2002, 34712, 86578, 'sbompass8@cnet.com');
